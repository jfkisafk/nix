{ pkgs, ... }: {
  ...
  settings = {
    ...
    buf.symbol = "■ ";
    buf.format = " [buf](italic) [$symbol $version $buf_version]($style)";

    c.symbol = "ℂ ";
    c.format = " [$symbol($version(-$name))]($style)";

    conda.symbol = "◯ ";
    conda.format = " conda [$symbol$environment]($style)";

    dart.symbol = "◁◅ ";
    dart.format = " dart [$symbol($version )]($style)";

    docker_context.symbol = "◧ ";
    docker_context.format = " docker [$symbol$context]($style)";

    elixir.symbol = " ";
    elixir.format = " exs [$symbol $version OTP $otp_version ]($style)";

    elm.symbol = "◩ ";
    elm.format = " elm [$symbol($version )]($style)";

    golang.symbol = "∩ ";
    golang.format = " go [$symbol($version )]($style)";

    haskell.symbol = "❯λ ";
    haskell.format = " hs [$symbol($version )]($style)";

    java.symbol = "∪ ";
    java.format = " java [\${symbol}(\${version} )]($style)";

    julia.symbol = "◎ ";
    julia.format = " jl [$symbol($version )]($style)";

    memory_usage.symbol = "▪▫▪ ";
    memory_usage.format = " mem [\${ram}( \${swap})]($style)";

    nim.symbol = "▴▲▴ ";
    nim.format = " nim [$symbol($version )]($style)";
    ...
    spack.symbol = "◇ ";
    spack.format = " spack [$symbol$environment]($style)";
  };
} 