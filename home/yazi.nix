  ...
  theme = {
    icon = {
      files = [
        ...
        { name = ".clang-format";               text = ""; fg = "#524f67"; }
        { name = ".clang-tidy";                 text = ""; fg = "#524f67"; }
        ...
        { name = "commitlint.config.js";        text = "󰜘"; fg = "#31748f"; }
        { name = "commitlint.config.ts";        text = "󰜘"; fg = "#31748f"; }
        ...
        { name = "hypridle.conf";               text = ""; fg = "#31748f"; }
        { name = "hyprland.conf";               text = ""; fg = "#31748f"; }
        { name = "hyprlock.conf";               text = ""; fg = "#31748f"; }
        { name = "hyprpaper.conf";              text = ""; fg = "#31748f"; }
        ...
        { name = "kritadisplayrc";              text = ""; fg = "#31748f"; }
        { name = "kritarc";                     text = ""; fg = "#31748f"; }
        ...
        { name = "mpv.conf";                    text = ""; fg = "#31748f"; }
        { name = "node_modules";                text = ""; fg = "#eb6f92"; }
        { name = "nuxt.config.cjs";             text = "󱄆"; fg = "#f6c177"; }
        { name = "nuxt.config.js";              text = "󱄆"; fg = "#f6c177"; }
        { name = "nuxt.config.mjs";             text = "󱄆"; fg = "#f6c177"; }
        { name = "nuxt.config.ts";              text = "󱄆"; fg = "#f6c177"; }
      ...
      exts = [
        ...
        { name = "crdownload";    text = ""; fg = "#f6c177"; }
        ...
        { name = "f3d";           text = "󰻫"; fg = "#9ccfd8"; }
        { name = "f90";           text = "󱈚"; fg = "#31748f"; }
        { name = "fbx";           text = "󰆧"; fg = "#21202e"; }
        ...
        { name = "fdmdownload";   text = ""; fg = "#f6c177"; }
        ...
        { name = "gnumakefile";   text = ""; fg = "#21202e"; }
        { name = "go";            text = ""; fg = "#31748f"; }
        { name = "godot";         text = ""; fg = "#21202e"; }
        { name = "gpr";           text = ""; fg = "#eb6f92"; }
        ...
        { name = "ifc";           text = "󰻫"; fg = "#9ccfd8"; }
        { name = "ige";           text = "󰻫"; fg = "#9ccfd8"; }
        { name = "iges";          text = "󰻫"; fg = "#9ccfd8"; }
        { name = "igs";           text = "󰻫"; fg = "#9ccfd8"; }
        { name = "image";         text = ""; fg = "#e0def4"; }
        { name = "img";           text = ""; fg = "#e0def4"; }
        { name = "import";        text = ""; fg = "#e0def4"; }
        { name = "info";          text = ""; fg = "#9ccfd8"; }
        { name = "ini";           text = ""; fg = "#21202e"; }
        { name = "ino";           text = ""; fg = "#31748f"; }
        ...
        { name = "m3u";           text = "󰲹"; fg = "#c4a7e7"; }
        { name = "m3u8";          text = "󰲹"; fg = "#c4a7e7"; }
        { name = "m4a";           text = ""; fg = "#31748f"; }
        { name = "m4v";           text = ""; fg = "#f6c177"; }
        { name = "magnet";        text = ""; fg = "#eb6f92"; }
        { name = "makefile";      text = ""; fg = "#21202e"; }
        ...
        { name = "rlib";          text = ""; fg = "#ebbcba"; }
        { name = "rmd";           text = ""; fg = "#31748f"; }
        { name = "rproj";         text = "󰗆"; fg = "#f6c177"; }
        { name = "rs";            text = ""; fg = "#ebbcba"; }
        ...
        { name = "skp";           text = "󰻫"; fg = "#9ccfd8"; }
        { name = "sldasm";        text = "󰻫"; fg = "#9ccfd8"; }
        { name = "sldprt";        text = "󰻫"; fg = "#9ccfd8"; }
        { name = "slim";          text = ""; fg = "#eb6f92"; }
        { name = "sln";           text = ""; fg = "#31748f"; }
        { name = "slnx";          text = ""; fg = "#31748f"; }
        { name = "slvs";          text = "󰻫"; fg = "#9ccfd8"; }
        ...
        { name = "ste";           text = "󰻫"; fg = "#9ccfd8"; }
        { name = "step";          text = "󰻫"; fg = "#9ccfd8"; }
        { name = "stl";           text = "󰆧"; fg = "#21202e"; }
        { name = "stp";           text = "󰻫"; fg = "#9ccfd8"; }
        ...
        { name = "torrent";       text = ""; fg = "#f6c177"; }
        { name = "tres";          text = ""; fg = "#21202e"; }
        { name = "ts";            text = ""; fg = "#31748f"; }
        { name = "tscn";          text = ""; fg = "#21202e"; }
        ...
        { name = "typ";           text = ""; fg = "#31748f"; }
        { name = "typoscript";    text = ""; fg = "#f6c177"; }
        { name = "ui";            text = ""; fg = "#eb6f92"; }
        ...
        { name = "wrl";           text = "󰆧"; fg = "#21202e"; }
        { name = "wrz";           text = "󰆧"; fg = "#21202e"; }
